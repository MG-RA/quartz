...
- Not irreversibility itself (persistence is a condition; irreversibility describes cost asymmetry over transitions)

## Structural role

Persistent difference fixes what counts as _undone_ versus merely _obscured_. Once a difference is persistent, claims of correction, rollback, or reversal are incomplete unless they specify **where the erasure cost landed**. Without this concept, systems can repeatedly declare success while silently accumulating constraints.
